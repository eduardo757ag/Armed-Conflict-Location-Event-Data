...
DATA$`ARMED GROUP CONFLICT` <- DATA$`ARMED GROUP CONFLICT` %>% 
  as.numeric()
DATA$`CIVILIAN INVOLVED CONFLICT`<- DATA$`CIVILIAN INVOLVED CONFLICT` %>% 
  as.numeric()
```
...
facebook <- apply(facebook,2,toupper)
facebook <- as.data.frame(facebook)
=======
>>>>>>> 11ef954e209a5b8974e894661a1e00abeb69b6cf
